!function(A, e) {
    ...
    return function(A) {
        function e(r) {
            ...
            return A[r].call(n.exports, n, n.exports, e),
            n.l = !0,
            n.exports
        }
        var t = {};
        ...
        var r = function() {
                ...
                if (Symbol.iterator in Object(A))
                    return function(A, e) {
                        var t = []
                          ...
                          , B = void 0;
                        try {
                            for (var s, a = A[Symbol.iterator](); !(r = (s = a.next()).done) && (t.push(s.value),
                            !e || t.length !== e); r = !0)
                                ;
                        } catch (A) {
                            n = !0,
          ...
          , U = function() {
            function A(e) {
                ...
                var t = Array.isArray(e) ? Q(e) : s(e) || c(e) || u(e) || w(e) || o(e) || [0, 0, 0, null]
                  , n = r(t, 4)
                  , B = n[0]
                  , a = n[1]
                  , i = n[2]
    ...
    , function(A, e, t) {
        ...
        var s = e.LENGTH_TYPE = {
          ...
          , a = function() {
            function A(e) {
                ...
                this.type = "%" === e.substr(e.length - 1) ? s.PERCENTAGE : s.PX;
                var t = parseFloat(e);
        ...
        e.calculateLengthFromValueWithUnit = function(A, e, t) {
            ...
            case "rem":
                var r = new a(e);
                return r.value *= "em" === t ? parseFloat(A.style.font.fontSize) : function n(A) {
                    var e = A.parent;
                    return e ? n(e) : parseFloat(A.style.font.fontSize)
                }(A),
                r;
            default:
                return new a("0")
    ...
    , function(A, e, t) {
        ...
        function(A, e, t, r) {
            var n = [];
            return A instanceof s["default"] ? n.push(A.subdivide(.5, !1)) : n.push(A),
            t instanceof s["default"] ? n.push(t.subdivide(.5, !0)) : n.push(t),
            r instanceof s["default"] ? n.push(r.subdivide(.5, !0).reverse()) : n.push(r),
            e instanceof s["default"] ? n.push(e.subdivide(.5, !1).reverse()) : n.push(e),
            n
        }
        )
        ...
        e.parseBoundCurves = function(A, e, t) {
            var r = t[i.TOP_LEFT][0].getAbsoluteValue(A.width)
              , n = t[i.TOP_LEFT][1].getAbsoluteValue(A.height)
            ...
            var g = A.width - s
              ...
              , F = A.height - Q;
            return {
                topLeftOuter: r > 0 || n > 0 ? c(A.left, A.top, r, n, i.TOP_LEFT) : new B["default"](A.left,A.top),
                topLeftInner: r > 0 || n > 0 ? c(A.left + e[3].borderWidth, A.top + e[0].borderWidth, Math.max(0, r - e[3].borderWidth), Math.max(0, n - e[0].borderWidth), i.TOP_LEFT) : new B["default"](A.left + e[3].borderWidth,A.top + e[0].borderWidth),
                topRightOuter: s > 0 || a > 0 ? c(A.left + g, A.top, s, a, i.TOP_RIGHT) : new B["default"](A.left + A.width,A.top),
                topRightInner: s > 0 || a > 0 ? c(A.left + Math.min(g, A.width + e[3].borderWidth), A.top + e[0].borderWidth, g > A.width + e[3].borderWidth ? 0 : s - e[3].borderWidth, a - e[0].borderWidth, i.TOP_RIGHT) : new B["default"](A.left + A.width - e[1].borderWidth,A.top + e[0].borderWidth),
                bottomRightOuter: o > 0 || l > 0 ? c(A.left + d, A.top + C, o, l, i.BOTTOM_RIGHT) : new B["default"](A.left + A.width,A.top + A.height),
                bottomRightInner: o > 0 || l > 0 ? c(A.left + Math.min(d, A.width - e[3].borderWidth), A.top + Math.min(C, A.height + e[0].borderWidth), Math.max(0, o - e[1].borderWidth), l - e[2].borderWidth, i.BOTTOM_RIGHT) : new B["default"](A.left + A.width - e[1].borderWidth,A.top + A.height - e[2].borderWidth),
                bottomLeftOuter: u > 0 || Q > 0 ? c(A.left, A.top + F, u, Q, i.BOTTOM_LEFT) : new B["default"](A.left,A.top + A.height),
                bottomLeftInner: u > 0 || Q > 0 ? c(A.left + e[3].borderWidth, A.top + F, Math.max(0, u - e[3].borderWidth), Q - e[2].borderWidth, i.BOTTOM_LEFT) : new B["default"](A.left + e[3].borderWidth,A.top + A.height - e[2].borderWidth)
            }
        }
        ,
        {
    ...
    , function(A, e, t) {
        ...
        var r, n = function() {
        ...
        }(), B = t(0), s = (r = B) && r.__esModule ? r : {
            "default": r
        }, a = t(4), o = t(5), i = t(12), c = t(33), l = t(34), u = t(35), Q = t(36), w = t(37), U = t(38), g = t(8), C = t(39), d = t(40), F = t(18), f = t(17), E = t(19), h = t(11), H = t(41), p = t(20), N = t(42), I = t(43), K = t(44), T = t(45), m = t(2), b = t(21), v = t(14), y = ["INPUT", "TEXTAREA", "SELECT"], L = function() {
            function A(e, t, r, n) {
                var B = this;
                !function(A, e) {
                    if (!(A instanceof e))
                ...
                var a = e.ownerDocument.defaultView
                  , L = a.pageXOffset
                  , _ = a.pageYOffset
                  , D = a.getComputedStyle(e, null)
                  , M = (0,
                l.parseDisplay)(D.display)
                  , O = "radio" === e.type || "checkbox" === e.type
                  , R = (0,
                E.parsePosition)(D.position);
                if (this.style = {
                    background: O ? b.INPUT_BACKGROUND : (0,
                    o.parseBackground)(D, r),
                    border: O ? b.INPUT_BORDERS : (0,
                    i.parseBorder)(D),
                    borderRadius: (e instanceof a.HTMLInputElement || e instanceof HTMLInputElement) && O ? (0,
                    b.getInputBorderRadius)(e) : (0,
                    c.parseBorderRadius)(D),
                    color: O ? b.INPUT_COLOR : new s["default"](D.color),
                    display: M,
                    "float": (0,
                    ...
                    overflow: -1 === y.indexOf(e.tagName) ? (0,
                    ...
                    zIndex: (0,
                    T.parseZIndex)(R !== E.POSITION.STATIC ? D.zIndex : "auto")
                },
                ...
                this.image = S(e, r),
                this.bounds = O ? (0,
                b.reformatInputBounds)((0,
                m.parseBounds)(e, L, _)) : (0,
                m.parseBounds)(e, L, _),
                this.curvedBounds = (0,
            ...
            return n(A, [{
                ...
                value: function() {
                    return !(0,
                    a.contains)(this.style.display, l.DISPLAY.NONE) && this.style.opacity > 0 && this.style.visibility === I.VISIBILITY.VISIBLE
                }
            }, {
                key: "isAbsolutelyPositioned",
                value: function() {
                    return this.style.position !== E.POSITION.STATIC && this.style.position !== E.POSITION.RELATIVE
                }
            }, {
                key: "isPositioned",
                value: function() {
                    return this.style.position !== E.POSITION.STATIC
                }
            }, {
                key: "isFloating",
                value: function() {
                ...
                value: function() {
                    return (0,
                    a.contains)(this.style.display, l.DISPLAY.INLINE) || (0,
                    a.contains)(this.style.display, l.DISPLAY.INLINE_BLOCK) || (0,
                    a.contains)(this.style.display, l.DISPLAY.INLINE_FLEX) || (0,
                    a.contains)(this.style.display, l.DISPLAY.INLINE_GRID) || (0,
                    a.contains)(this.style.display, l.DISPLAY.INLINE_LIST_ITEM) || (0,
                    a.contains)(this.style.display, l.DISPLAY.INLINE_TABLE)
                }
            }, {
    ...
    , function(A, e, t) {
        ...
        var n = r(t(0))
          ...
          , U = (e.calculateBackgroundSize = function(A, e, t) {
            ...
            return B[0].value && (r = B[0].value.getAbsoluteValue(t.width)),
            B[0].size === l.AUTO && B[1].size === l.AUTO ? n = e.height : B[1].size === l.AUTO ? n = r / e.width * e.height : B[1].value && (n = B[1].value.getAbsoluteValue(t.height)),
        ...
        new w("auto"))
          , g = (e.calculateBackgroungPaintingArea = function(A, e) {
            ...
            case u.BORDER_BOX:
                return (0,
                o.calculateBorderBoxPath)(A);
            case u.PADDING_BOX:
            default:
                return (0,
                o.calculatePaddingBoxPath)(A)
            }
        }
        ,
        e.calculateBackgroungPositioningArea = function(A, e, t, r) {
            var n = (0,
            o.calculatePaddingBox)(e, r);
            switch (A) {
            case Q.BORDER_BOX:
                return e;
            case Q.CONTENT_BOX:
          ...
          , B = {
            ...
            get SUPPORT_FOREIGNOBJECT_DRAWING() {
                var A = "function" == typeof Array.from && "function" == typeof window.fetch ? function(A) {
                    ...
                    t.fillRect(0, 0, 100, 100),
                    (0,
                    r.loadSerializedSVG)(a).then(function(e) {
                        t.drawImage(e, 0, 0);
                        var B = t.getImageData(0, 0, 100, 100).data;
                        t.fillStyle = "red",
                        t.fillRect(0, 0, 100, 100);
                        var a = A.createElement("div");
                        return a.style.backgroundImage = "url(" + s + ")",
                        a.style.height = "100px",
                        n(B) ? (0,
                        r.loadSerializedSVG)((0,
                        r.createForeignObjectSVG)(100, 100, 0, 0, a)) : Promise.reject(!1);
                    }).then(function(A) {
    ...
    , function(A, e, t) {
        ...
        e.parseTextDecoration = function(A) {
            ...
            return null === t ? a.NONE : {
                ...
                textDecorationColor: hotpink : null,
        ...
        e.inlineListItemElement = function(A, e, t) {
            ...
            if (r) {
                ...
                if (u)
                    ...
                    "number" == typeof e.listIndex && (c = A.ownerDocument.createTextNode(F(e.listIndex, r.listStyleType, !0)),
                    i.appendChild(c),
                    i.style.top = e.bounds.top - l + "px");
                var U = A.ownerDocument.body;
                U.appendChild(i),
                c ? (e.childNodes.push(s["default"].fromTextNode(c, e)),
                U.removeChild(i)) : e.childNodes.push(new B["default"](i,e,t,0))
            }
        }
        ,
        {
          ...
          , g = function(A, e, t, r, n) {
            ...
            return (A < 0 ? "-" : "") + (U(Math.abs(A), B, r, function(A) {
                return (0,
                o.fromCodePoint)(Math.floor(A % B) + e)
            }) + n)
        }
          , C = function(A, e) {
          ...
          , d = function(A, e, t, r, B, s) {
            ...
            for (var c = 0; o > 0 && c <= 4; c++) {
                var l = o % 10;
                0 === l && (0,
                n.contains)(s, 1) && "" !== i ? i = e[l] + i : l > 1 || 1 === l && 0 === c || 1 === l && 1 === c && (0,
                n.contains)(s, 2) || 1 === l && 1 === c && (0,
                n.contains)(s, 4) && A > 100 || 1 === l && c > 1 && (0,
                n.contains)(s, 8) ? i = e[l] + (c > 0 ? t[c - 1] : "") + i : 1 === l && c > 0 && (i = t[c - 1] + i),
                o = Math.floor(o / 10)
            }
            return (A < 0 ? r : "") + i
        }
                ...
                value: function(A, e, t, r, n) {
                    ...
                    A.forEach(function(A) {
                        ...
                        n && A.text.trim().length ? n.slice(0).reverse().forEach(function(e) {
                            ...
                            s.ctx.fillText(A.text, A.bounds.left, A.bounds.top + A.bounds.height)
                        }) : s.ctx.fillText(A.text, A.bounds.left, A.bounds.top + A.bounds.height),
                        null !== r) {
    ...
    , function(A, e, t) {
        ...
        function(A, e, t, r) {
            ...
            if (A.length > 0 && B) {
                ...
                (0,
                l.copyCSSStyles)(e.ownerDocument.defaultView.getComputedStyle(e, null), s),
    ...
    , function(A, e, t) {
        ...
        var r, n = t(2), B = t(11), s = t(10), a = (r = s) && r.__esModule ? r : {
            "default": r
        }, o = t(24), i = e.TextBounds = function u(A, e) {
            !function(A, e) {
                if (!(A instanceof e))
                    throw new TypeError("Cannot call a class as a function")
            }(this, u),
        ...
        , c = (e.parseTextBounds = function(A, e, t) {
            ...
            o.breakWords)(A, e), n = r.length, s = t.parentNode ? t.parentNode.ownerDocument.defaultView : null, u = s ? s.pageXOffset : 0, Q = s ? s.pageYOffset : 0, w = [], U = 0, g = 0; g < n; g++) {
                var C = r[g];
                if (e.style.textDecoration !== B.TEXT_DECORATION.NONE || C.trim().length > 0)
                    ...
                    a["default"].SUPPORT_RANGE_BOUNDS || (t = t.splitText(C.length));
                U += C.length
            }
            return w
        }
    ...
    , function(A, e, t) {
        ...
        var B = e.createForeignObjectSVG = function(A, e, t, r, n) {
            ...
            return s.setAttributeNS(null, "width", A),
    ...
    , function(A, e, t) {
        ...
        var n, B = t(3), s = ((n = B) && n.__esModule,
        t(18));
        e.breakWords = function(A, e) {
            for (var t = (0,
            r.LineBreaker)(A, {
                lineBreak: e.style.lineBreak,
                wordBreak: e.style.overflowWrap === s.OVERFLOW_WRAP.BREAK_WORD ? "break-word" : e.style.wordBreak
    ...
    , function(A, e, t) {
        ...
        e.Proxy = function(A, e) {
            ...
            return new Promise(function(r, n) {
                var s = B["default"].SUPPORT_CORS_XHR && B["default"].SUPPORT_RESPONSE_TYPE ? "blob" : "text"
                  , a = B["default"].SUPPORT_CORS_XHR ? new XMLHttpRequest : new XDomainRequest;
                ...
                ,
                a.onerror = n,
                a.open("GET", t + "?url=" + encodeURIComponent(A) + "&responseType=" + s),
    ...
    , function(A, e, t) {
        ...
        var n = Object.assign || function(A) {
          ...
          , o = function(A, e) {
            ...
            r.log("html2canvas 1.0.0-alpha.12");
            ...
            var i = o.defaultView
              ...
              , l = (0,
            a.renderElement)(A, n({}, c, t), r);
            return l
        };
        o.CanvasRenderer = B["default"],
        A.exports = o
    }
    , function(A, e, t) {
        "use strict";
        ...
        t(29))
          ...
          , u = t(0)
          , Q = r(u);
        e.renderElement = function w(A, e, t) {
            var r = A.ownerDocument
              , U = new i.Bounds(e.scrollX,e.scrollY,e.windowWidth,e.windowHeight)
              , g = r.documentElement ? new Q["default"](getComputedStyle(r.documentElement).backgroundColor) : u.TRANSPARENT
              , C = r.body ? new Q["default"](getComputedStyle(r.body).backgroundColor) : u.TRANSPARENT
              , d = A === r.documentElement ? g.isTransparent() ? C.isTransparent() ? e.backgroundColor ? new Q["default"](e.backgroundColor) : null : C : g : e.backgroundColor ? new Q["default"](e.backgroundColor) : null;
            return (e.foreignObjectRendering ? o["default"].SUPPORT_FOREIGNOBJECT_DRAWING : Promise.resolve(!1)).then(function(o) {
                return o ? (Q = new c.DocumentCloner(A,e,t,(!0),w)).inlineFonts(r).then(function() {
                    return Q.resourceLoader.ready()
                }).then(function() {
                    var n = new a["default"](Q.documentElement)
                      , B = r.defaultView
                      , s = B.pageXOffset
                      , o = B.pageYOffset
                      , c = "HTML" === A.tagName || "BODY" === A.tagName ? (0,
                    i.parseDocumentSize)(r) : (0,
                    i.parseBounds)(A, s, o)
                      , l = c.width
                      , u = c.height
                      , w = c.left
                    ...
                    return n.render({
                        ...
                        y: "number" == typeof e.y ? e.y : U,
                        width: "number" == typeof e.width ? e.width : Math.ceil(l),
                        height: "number" == typeof e.height ? e.height : Math.ceil(u),
                ...
                c.cloneWindow)(r, U, A, e, t, w).then(function(A) {
                    var a = n(A, 3)
                      , o = a[0]
                      , c = a[1]
                      , Q = a[2]
                    ...
                    B.NodeParser)(c, Q, t)
                      , U = c.ownerDocument;
                    return d === w.container.style.background.backgroundColor && (w.container.style.background.backgroundColor = u.TRANSPARENT),
                    Q.ready().then(function(A) {
                        var n = new l.FontMetrics(U)
                          , B = U.defaultView
                          , a = B.pageXOffset
                          , u = B.pageYOffset
                          , Q = "HTML" === c.tagName || "BODY" === c.tagName ? (0,
                        i.parseDocumentSize)(r) : (0,
                        i.parseBounds)(c, a, u)
                          , g = Q.width
                          , C = Q.height
                          ...
                          , E = {
                            ...
                            logger: t,
                            scale: e.scale,
                            x: "number" == typeof e.x ? e.x : F,
                            y: "number" == typeof e.y ? e.y : f,
                            width: "number" == typeof e.width ? e.width : Math.ceil(g),
                            height: "number" == typeof e.height ? e.height : Math.ceil(C)
                        };
                        if (Array.isArray(e.target))
                            return Promise.all(e.target.map(function(A) {
                                return new s["default"](A,E).render(w)
                            }));
                        var h = new s["default"](e.target,E).render(w);
                        return !0 === e.removeContainer && o.parentNode && o.parentNode.removeChild(o),
                        h
                    })
                });
                var Q
            ...
            for (var w, g = A.firstChild; g; g = w) {
                ...
                if (g instanceof C.Text || g instanceof Text || C.parent && g instanceof C.parent.Text)
                    ...
                    if (-1 === c.indexOf(g.nodeName)) {
                        var d = new B["default"](g,e,r,(l++));
                        if (d.isVisible()) {
                            "INPUT" === g.tagName ? (0,
                            a.inlineInputElement)(g, d) : "TEXTAREA" === g.tagName ? (0,
                            a.inlineTextAreaElement)(g, d) : "SELECT" === g.tagName ? (0,
                            a.inlineSelectElement)(g, d) : d.style.listStyle && d.style.listStyle.listStyleType !== i.LIST_STYLE_TYPE.NONE && (0,
                            o.inlineListItemElement)(g, d, r);
                            var F = "TEXTAREA" !== g.tagName
                              , f = u(d, g);
                            if (f || Q(d)) {
                                var E = f || d.isPositioned() ? t.getRealParentStackingContext() : t
                                  , h = new n["default"](d,E,f);
                                E.contexts.push(h),
                                F && U(g, d, h, r, l)
                            } else
                                t.children.push(d),
                    ...
                    var H = new B["default"](g,e,r,(l++))
                      , p = u(H, g);
                    if (p || Q(H)) {
                        var N = p || H.isPositioned() ? t.getRealParentStackingContext() : t
    ...
    , function(A, e, t) {
        ...
        }(), B = t(6), s = t(7), a = (r = s) && r.__esModule ? r : {
            "default": r
        }, o = function(A, e, t) {
            ...
            return n(A, [{
                ...
                value: function(e, t) {
                    var r = o(this.start, this.startControl, e)
                      ...
                      , a = o(n, B, e)
                      , i = o(s, a, e);
                    return t ? new A(this.start,r,s,i) : new A(i,a,B,this.end)
                }
            }, {
                key: "reverse",
                value: function() {
    ...
    , function(A, e, t) {
        ...
        }(), B = t(1), s = (r = B) && r.__esModule ? r : {
            "default": r
        }, a = ["top-left", "top-right", "bottom-right", "bottom-left"];
        e.parseBorderRadius = function(A) {
            return a.map(function(e) {
                var t = A.getPropertyValue("border-" + e + "-radius").split(" ").map(s["default"].create)
                  , r = n(t, 2)
                  , B = r[0]
                  , a = r[1];
                return void 0 === a ? [B, B] : [B, a]
            })
        }
    }
    , function(A, e, t) {
    ...
    , function(A, e, t) {
        ...
        e.parseTextShadow = function(A) {
            if ("none" === A || "string" != typeof A)
                return null;
            for (var e = "", t = !1, r = [], n = [], a = 0, o = null, i = function() {
    ...
    , function(A, e, t) {
        ...
        }, a = /(matrix|matrix3d)\((.+)\)/, o = (e.parseTransform = function(A) {
        ...
        function(A) {
            ...
            if (e) {
                if ("matrix" === e[1]) {
                    var t = e[2].split(",").map(s);
                    return [t[0], t[1], t[2], t[3], t[4], t[5]]
                }
                var r = e[2].split(",").map(s);
    ...
    , function(A, e, t) {
        ...
        }(), s = t(48), a = t(49), o = (r = a) && r.__esModule ? r : {
            "default": r
        }, i = t(13), c = e.LETTER_NUMBER_MODIFIER = 50, l = 10, u = 13, Q = 15, w = 17, U = 18, g = 19, C = 20, d = 21, F = 22, f = 24, E = 25, h = 26, H = 27, p = 28, N = 30, I = 32, K = 33, T = 34, m = 35, b = 37, v = 38, y = 39, L = 40, S = 42, _ = (e.classes = {
            BK: 1,
            CR: 2,
            LF: 3,
            CM: 4,
        ...
        e.BREAK_MANDATORY = "!"), D = e.BREAK_NOT_ALLOWED = "×", M = e.BREAK_ALLOWED = "÷", O = e.UnicodeTrie = (0,
        s.createTrieFromBase64)(o["default"]), R = [N, 36], P = [1, 2, 3, 5], X = [l, 8], z = [H, h], x = P.concat(X), V = [v, y, L, T, m], k = [Q, u], J = e.codePointsToCharacterClasses = function(A) {
            ...
            return A.forEach(function(A, B) {
                ...
                if (4 === s || 11 === s) {
                    if (0 === B)
                        ...
                        t.push(N);
                    var a = t[B - 1];
                    return -1 === x.indexOf(a) ? (r.push(r[B - 1]),
                    t.push(a)) : (r.push(B),
                    t.push(N))
                }
                return r.push(B),
                31 === s ? t.push("strict" === e ? d : b) : s === S ? t.push(N) : 29 === s ? t.push(N) : 43 === s ? A >= 131072 && A <= 196605 || A >= 196608 && A <= 262141 ? t.push(b) : t.push(N) : void t.push(s)
            }),
            [r, t, n]
        }
        , G = function(A, e, t, r) {
            ...
            if (o === p && 36 === c)
                return D;
            if (c === C && -1 !== R.concat(C, g, E, b, I, K).indexOf(o))
                return D;
            if (-1 !== R.indexOf(c) && o === E || -1 !== R.indexOf(o) && c === E)
                return D;
            if (o === H && -1 !== [b, I, K].indexOf(c) || -1 !== [b, I, K].indexOf(o) && c === h)
                return D;
            if (-1 !== R.indexOf(o) && -1 !== z.indexOf(c) || -1 !== z.indexOf(o) && -1 !== R.indexOf(c))
                return D;
            if (-1 !== [H, h].indexOf(o) && (c === E || -1 !== [F, Q].indexOf(c) && e[a + 1] === E) || -1 !== [F, Q].indexOf(o) && c === E || o === E && -1 !== [E, p, f].indexOf(c))
                return D;
            if (-1 !== [E, p, f, w, U].indexOf(c))
                for (var N = B; N >= 0; ) {
                    var S = e[N];
                    if (S === E)
                        return D;
            ...
            if (-1 !== [H, h].indexOf(c))
                for (var x = -1 !== [w, U].indexOf(o) ? s : B; x >= 0; ) {
                    var J = e[x];
                    if (J === E)
                        return D;
                    if (-1 === [p, f].indexOf(J))
            ...
            if (v === o && -1 !== [v, y, T, m].indexOf(c) || -1 !== [y, T].indexOf(o) && -1 !== [y, L].indexOf(c) || -1 !== [L, m].indexOf(o) && c === L)
                return D;
            if (-1 !== V.indexOf(o) && -1 !== [C, h].indexOf(c) || -1 !== V.indexOf(c) && o === H)
                return D;
            if (-1 !== R.indexOf(o) && -1 !== R.indexOf(c))
                return D;
            if (o === f && -1 !== R.indexOf(c))
                return D;
            if (-1 !== R.concat(E).indexOf(o) && c === F || -1 !== R.concat(E).indexOf(c) && o === U)
                return D;
            if (41 === o && 41 === c) {
        ...
        function(A, e) {
            ...
            return t.forEach(function(A, e) {
                r += (0,
                i.fromCodePoint)(A) + (e >= t.length - 1 ? _ : W(t, o, a, e + 1, c))
            }),
            r
        }
        ,
        ...
        e.LineBreaker = function(A, e) {
            ...
            return {
                next: function() {
                    ...
                    for (var A = D; u < c && (A = W(t, a, s, ++u, o)) === D; )
                        ;
                    if (A !== D || u === c) {
                        var e = new q(t,A,l,u);
                        return l = u,
                ...
                value: function(A) {
                    ...
                    if (A >= 0) {
                        if (A < 55296 || A > 56319 && A <= 65535)
                            return e = ((e = this.index[A >> B]) << a) + (A & l),
                            this.data[e];
                        if (A <= 65535)
                            return e = ((e = this.index[i + (A - 55296 >> B)]) << a) + (A & l),
                            this.data[e];
                        if (A < this.highStart)
                            return e = g - C + (A >> s),
                            e = this.index[e],
            ...
            return B(A, [{
                    ...
                    var e = this
                      , t = function() {
                        ...
                        A.image) {
                            ...
                            if (t) {
                                var r = (0,
                                s.calculateContentBox)(A.bounds, A.style.padding, A.style.border)
                                ...
                                s.calculatePaddingBoxPath)(A.curvedBounds)], function() {
                                    e.target.drawImage(t, new s.Bounds(0,0,n,B), r)
                                })
                            }
                        }
                    }
                ...
                value: function(A, e) {
                    ...
                    c.calculateBackgroundPosition)(e.position, r, t)
                      , B = new s.Bounds(Math.round(t.left + n.x),Math.round(t.top + n.y),r.width,r.height)
                      , o = (0,
                    a.parseGradient)(A, e.source, B);
                    if (o)
                        switch (o.type) {
                ...
                value: function(A, e, t) {
                    ...
                    s.parsePathForBorder)(t, e), A.borderColor)
                }
            }, {
                key: "renderStack",
                value: function(A) {
    ...
    , function(A, e, t) {
        ...
        t(53))
          ...
          , F = e.LinearGradient = function y(A, e) {
            n(this, y),
            this.type = g.LINEAR_GRADIENT,
            this.colorStops = A,
            this.direction = e
        }
          , f = e.RadialGradient = function L(A, e, t, r) {
            n(this, L),
        ...
        function(A, e, t) {
          ...
          , h = function(A, e, t) {
            ...
            s.parseAngle)(A[0])
              ...
              , o = B ? 1 : 0
              , i = Math.min((0,
            c.distance)(Math.abs(a.x0) + Math.abs(a.x1), Math.abs(a.y0) + Math.abs(a.y1)), 2 * e.width, 2 * e.height);
            return new F(E(A, o, i),a)
        }
          , H = function(A, e, t) {
            var r = e[0].match(U)
              ...
              , s = {};
            r && (void 0 !== r[3] && (B.x = (0,
            o.calculateLengthFromValueWithUnit)(A, r[3], r[4]).getAbsoluteValue(t.width)),
            void 0 !== r[5] && (B.y = (0,
            o.calculateLengthFromValueWithUnit)(A, r[5], r[6]).getAbsoluteValue(t.height)),
            r[7] ? s.x = d[r[7].toLowerCase()] : void 0 !== r[8] && (s.x = (0,
            o.calculateLengthFromValueWithUnit)(A, r[8], r[9])),
            r[10] ? s.y = d[r[10].toLowerCase()] : void 0 !== r[11] && (s.y = (0,
            o.calculateLengthFromValueWithUnit)(A, r[11], r[12])));
            var a = {
            ...
            return new f(E(e, r ? 1 : 0, Math.min(i.x, i.y)),n,a,i)
        }
          , p = function(A, e) {
            var t = e.width
              , r = e.height
          ...
          , m = function(A, e, t, r, n) {
            ...
            switch (A) {
            case "closest-side":
                e === C.CIRCLE ? a = o = Math.min(Math.abs(B), Math.abs(B - n.width), Math.abs(s), Math.abs(s - n.height)) : e === C.ELLIPSE && (a = Math.min(Math.abs(B), Math.abs(B - n.width)),
            ...
            case "closest-corner":
                if (e === C.CIRCLE)
                    a = o = Math.min((0,
                    c.distance)(B, s), (0,
                    c.distance)(B, s - n.height), (0,
                    c.distance)(B - n.width, s), (0,
                    c.distance)(B - n.width, s - n.height));
                else if (e === C.ELLIPSE) {
                    var i = Math.min(Math.abs(s), Math.abs(s - n.height)) / Math.min(Math.abs(B), Math.abs(B - n.width))
                      , l = T(n, B, s, !0);
                    o = i * (a = (0,
                    c.distance)(l.x - B, (l.y - s) / i))
                }
                break;
            case "farthest-side":
                e === C.CIRCLE ? a = o = Math.max(Math.abs(B), Math.abs(B - n.width), Math.abs(s), Math.abs(s - n.height)) : e === C.ELLIPSE && (a = Math.max(Math.abs(B), Math.abs(B - n.width)),
        ...
        var n = function() {
            ...
            return B(A, [{
                ...
                value: function(A) {
                    ...
                    if (this.inlineImages && A) {
                        var t = A.style;
                        Promise.all((0,
                        c.parseBackgroundImage)(t.backgroundImage).map(function(A) {
                        ...
                        A instanceof HTMLImageElement && this.resourceLoader.inlineImage(A.src).then(function(e) {
                            if (e && A instanceof HTMLImageElement && A.parentNode) {
                                var t = A.parentNode
                                  , r = (0,
                                i.copyCSSStyles)(A.style, e.cloneNode(!1));
                                t.replaceChild(r, A)
                            }
                        })["catch"](function(A) {})
                    }
                    ...
                    if (A instanceof HTMLIFrameElement) {
                        ...
                        return this.resourceLoader.cache[n] = K(A, this.options).then(function(A) {
                            ...
                            return new Promise(function(t, n) {
                                ...
                                i.copyCSSStyles)(A.ownerDocument.defaultView.getComputedStyle(A), B), r)
                            }
                            )
                        }),
                        r
                ...
                value: function(A) {
                    ...
                    for (var s = (0,
                    u.parseCounterReset)(r, this.pseudoContentData), a = (0,
                    u.resolvePseudoContent)(A, n, this.pseudoContentData), o = A.firstChild; o; o = o.nextSibling)
                        o.nodeType === Node.ELEMENT_NODE && ("SCRIPT" === o.nodeName || o.hasAttribute("data-html2canvas-ignore") || "function" == typeof this.options.ignoreElements && this.options.ignoreElements(o)) || this.copyStyles && "STYLE" === o.nodeName || e.appendChild(this.cloneNode(o));
                    var c = (0,
                    u.resolvePseudoContent)(A, B, this.pseudoContentData);
                    if ((0,
                    u.popCounters)(s, this.pseudoContentData),
                    A instanceof t.HTMLElement && e instanceof t.HTMLElement)
                        switch (n && this.inlineAllImages(C(A, e, n, a, d)),
          ...
          , w = function(A, e) {
            return (A.cssRules ? Array.from(A.cssRules) : []).filter(function(A) {
                ...
                for (var t = (0,
                c.parseBackgroundImage)(A.style.getPropertyValue("src")), r = [], n = 0; n < t.length; n++)
                ...
                r)
                    for (var s = r.length, a = 0; a < s; a++) {
                        ...
                        case u.PSEUDO_CONTENT_ITEM_TYPE.IMAGE:
                            ...
                            l.src = (0,
                            c.parseBackgroundImage)("url(" + o.value + ")")[0].args[0],
                            l.style.opacity = "1",
                            B.appendChild(l);
                            break;
          ...
          , K = function(A, e) {
            try {
                ...
                a.Proxy)(A.src, e).then(function(A) {
                    ...
                    s.parseBounds)(A, 0, 0)).then(function(A) {
                ...
                var B = n.contentWindow
                  ...
                  , c = m(n).then(function() {
                    ...
                    var t = Promise.resolve([n, s.clonedReferenceElement, s.resourceLoader])
                      , a = r.onclone;
                    return s.clonedReferenceElement instanceof B.HTMLElement || s.clonedReferenceElement instanceof A.defaultView.HTMLElement || s.clonedReferenceElement instanceof HTMLElement ? "function" == typeof a ? Promise.resolve().then(function() {
                        return a(i)
                    }).then(function() {
                        return t
                    }) : t : Promise.reject("")
                    ...
                    if (!C(A) || a["default"].SUPPORT_SVG_DRAWING) {
                        ...
                        if (!this.isSameOrigin(A)) {
                            if ("string" == typeof this.options.proxy)
                                ...
                                o.Proxy)(A, this.options).then(function(A) {
                    ...
                    var r = this
                      , n = function(A) {
                        return new Promise(function(n, B) {
                            ...
                            s.onerror = B,
                            s.src = e,
                            !0 === s.complete && setTimeout(function() {
                                n(s)
                            }, 500),
